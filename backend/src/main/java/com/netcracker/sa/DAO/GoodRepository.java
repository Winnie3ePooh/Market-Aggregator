...
public interface GoodRepository extends PagingAndSortingRepository<Good, Long> {
    ...
    Page<Good> findByShopInAndTitleContainsIgnoreCase(Pageable pageable,List<Shop> shops,String keyword);
    ...
    List<Good> findByCreationDateGreaterThan(LocalDate time);
